  ...
  return (
    <section className="overflow-hidden px-6 py-32 sm:px-14 md:px-20">
      <div className="relative mx-auto max-w-7xl">
        ...
        <h2 className="relative z-10 text-xl font-semibold text-accent sm:text-3xl">
          My projects
        </h2>
        <div className="relative z-10 hidden flex-col gap-6 py-14 sm:gap-8 sm:py-20 md:gap-10 lg:flex">
        ...
        <Link
          href="/projects"
          className="group relative z-10 flex max-w-max items-center gap-4 text-base font-semibold sm:text-lg md:text-xl"
        >
